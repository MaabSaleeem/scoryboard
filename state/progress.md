...
| 07 | Teams | 11 | 63 | manager_pro | drafts on Intercom | [briefs/07.md](../briefs/07.md) | 63 screenshots, all eleven drafted. 07.7 and 07.9 retitled - the app has no ownership transfer and no Fan role. Accounts: `kb-manager-pro-07@`, `kb-fresh-07@`, six `kb-07-*@` |
...
Everything is on `kb/collection-07`, pushed. The image URLs resolve from that
branch's commits. Merging is the human's call.
